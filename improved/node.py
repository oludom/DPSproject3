...
from util_methods import register_service, get_ports_of_nodes, generate_node_id, get_top_node, elect_top_node, \
    ...
    if service_register_status == 200:
        ...
        if len(node_details) == 0:
            ...
            if election_ready or not wait:
                ...
                bully.election = True
                top_node = get_top_node(node_details, node_id)
                if top_node is None:
                    bully.coordinator = True
                    ...
                    elect_top_node(top_node, node_id)
    else:
